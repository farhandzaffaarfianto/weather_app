...
import 'package:weather_app/ui/profile_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY = 'c723cdd113874ad589132011240412';

  String location = 'Malang'; //Default location
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  // Tambahkan widget ini untuk teks "Welcome to Weatheris"
                  Text(
                    "Welcome to Weatheris",
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 24.0,
                  ...
                  // Widget Row dengan lokasi dan profil
                  Row(
